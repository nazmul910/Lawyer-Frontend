...
export const Card = React.memo(({
  ...
  <div
    ...
    className={cn(
      "rounded-lg relative bg-gray-100 dark:bg-neutral-900 overflow-hidden h-90 md:h-96 w-full transition-all duration-300 ease-out",
...
export function FocusCards({
  ...
  return (
    <div
      className=" px-6 md:px-10 lg:px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-10 max-w-5xl mx-auto w-full">
