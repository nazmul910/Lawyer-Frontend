...
const AboutSection = () =>{
    return(
        <>
            <section className="flex py-20 mt-10" id="about">
                <div className="">
                    <img src="/image/lawyer_client.jpeg" alt="" />
                </div>
                <div className="w-[90%] lg:px-10 xl:px-20 space-y-5 ">
                    <h1 className=" font-pt_serif font-bold text-4xl">We Properly Understand Your Purpose</h1>
                    ...
                    <button className="bg-button-bg px-7 py-3 font-semibold xl:mt-9 hover:bg-button-color hover:text-button-bg transition-all duration-500">Learn More</button>
                </div>
            </section> 
        </>
    )
